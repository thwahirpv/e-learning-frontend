...
const Login = ({ role }) => {
  ...
  useEffect(() => {
    setIsFormValid(
      formDataValid.email == true && formDataValid.password == true
    );
  }, [formDataValid]);
        ...
        <div className="w-full lg:w-[45%] flex justify-center items-center py-[35px] lg:py-0">
          <div className="w-[300px] border-[1px] border-gray-400 rounded-md px-4 py-5 space-y-7">
            ...
            <form action="">
              <div className="space-y-2">
                ...
                <button
                  ...
                  className={`relative mt-1 py-1.5 bg-light-blue-700 rounded-md w-full text-white ${
            ...
            <div className="pt-[30px] border-t-[1px] border-gray-400 dark:border-gray-500">
              <div className="flex cursor-pointer rounded-md py-1.5 justify-center space-x-3 items-center">
                {/* <span>
            ...
            <div className="mt-4 w-full text-center">
              {role !== "admin" && (
                <p className="text-sm font-[500] text-black-900 dark:text-white-900">
                  I am new here ?
                  <span
                    className="text-sm text-light-blue-800 font-[500] cursor-pointer"
